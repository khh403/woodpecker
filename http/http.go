...
// HTTPClient represents a wpkhttp object
...
// Request makes an wpkhttp request and returns the status, the content length, the headers, the body and an error
...
func DefaultUserAgent() string {
	return fmt.Sprintf("woodpecker/1.1.0")
}
